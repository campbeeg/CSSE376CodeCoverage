...
public class UserTest {
	...
	public void TestThatUserHasFrequentFlierMilesAfterBooking() {
		target.book(new Booking[] { new Flight(StartDate, EndDate, 1),
				new Hotel(5), new Car(3) });
	...
	@Test
	public void TestFullDoubleMiles() {
		Car car = new Car(5);
		Flight flight = new Flight(StartDate, EndDate, 1000);
		target.bookWithDoubleMiles(new Booking[] { flight });
		Assert.assertEquals(0, target.bonusFrequentFlierMiles, 0.01);
	}
	...
	public void TestThatDiscountInitializes() {
		...
		ServiceLocator.Instance().ClearDiscount();
	}
	
	@Test
	public void TestThatDiscountFirstFalse() {
	...
	@Test
	public void TestThatDiscountSecondFalse() {
